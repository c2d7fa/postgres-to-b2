...
describe("removing backups", () => {
  ...
  describe("when there are multiple backups each day two days in a row", () => {
    const example = [
      "test/postgres-2022-07-01T01-01-30-250Z.sql",
      "test/postgres-2022-07-01T05-30-30-550Z.sql",
      "test/postgres-2022-07-01T18-50-30-100Z.sql",
      "test/postgres-2022-07-02T03-02-30-100Z.sql",
      "test/postgres-2022-07-02T08-20-30-800Z.sql",
    ];
  ...
  describe("if a file does not have a valid format", () => {
    const example = [
      "test/postgres-2022-07-01T01-01-30-250Z.sql",
      "test/postgres-2022-01T05-30-30-550Z.sql", // Invalid name
      "test/postgres-2022-07-01T18-50-30-100Z.sql",
      "hello", // Invalid name
      "test/postgres-2022-07-02T08-20-30-800Z.sql",
    ];
